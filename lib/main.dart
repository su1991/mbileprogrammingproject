...
void main() {
  ...
  SystemChrome.setSystemUIOverlayStyle(
    SystemUiOverlayStyle(
      ...
      statusBarIconBrightness: Brightness.light, // Icons: light/dark
      statusBarBrightness: Brightness.dark, // For iOS (light/dark)
    ),
  );
  runApp(MyApp());
}
...
class FriendListPage extends StatelessWidget {
  final List<Map<String, String>> friends = [
    {'name': 'Alice', 'profilePic': 'https://via.placeholder.com/50', 'events': '1'},
    {'name': 'Bob', 'profilePic': 'https://via.placeholder.com/50', 'events': 'No Upcoming Events'},
    {'name': 'Charlie', 'profilePic': 'https://via.placeholder.com/50', 'events': '2'},
  ];
